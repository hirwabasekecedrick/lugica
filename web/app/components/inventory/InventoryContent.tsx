                ...
                lowStockProducts.map((p) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-8 h-8 rounded-lg bg-[#0d1525] border border-[#263B6A] flex items-center justify-center text-sm">
                        {p.image}
                      </span>
                      <div>
            ...
            <div className="space-y-3">
              {procurementBatches.slice(0, 3).map((b) => (
                <div key={b.id} className="flex items-start gap-3 p-2.5 rounded-lg bg-[#131e36]/40 border border-[#263B6A]/40">
                  <span className="w-7 h-7 rounded-lg bg-[#A0D585]/15 text-[#A0D585] border border-[#A0D585]/30 flex items-center justify-center text-xs flex-shrink-0 mt-0.5">
                    📥
                  </span>
              ...
              <div className="flex items-start gap-3 p-2.5 rounded-lg bg-[#131e36]/40 border border-[#263B6A]/40">
                <span className="w-7 h-7 rounded-lg bg-[#6984A9]/15 text-[#6984A9] border border-[#6984A9]/30 flex items-center justify-center text-xs flex-shrink-0 mt-0.5">
                  🚚
                </span>
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-white truncate">
